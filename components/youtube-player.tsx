  ...
  return (
    <div className={`relative w-full ${className}`}>
      <div className="aspect-video w-full max-w-full bg-black rounded-lg overflow-hidden relative">
        ...
        />
        {/* Audio-only overlay - always rendered but visibility controlled */}
        <div className={`absolute inset-0 bg-black z-10 flex items-center justify-center transition-opacity ${mode === 'audio-only' ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
